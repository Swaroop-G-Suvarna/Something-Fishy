...
public class RequestFragment extends Fragment {
    ...
    RequestAdapter.RecyclerViewClickListener listener;
    LinearLayout layout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = root.findViewById(R.id.requestRecycle);
        layout = root.findViewById(R.id.requestlayout);
    ...
    private void loadData() {
        ...
        Call<List<RequestModal>> requestCall = apiInterface.getViewRequestData(boatno);
                ...
                try {
                    ...
                    if(response.isSuccessful()) {
                        if (response.body() != null) {
                            ...
                            listener = new RequestAdapter.RecyclerViewClickListener() {
                                @Override
                                public void onClick(View v, int position) {

                                }
                            };
                            adapter = new RequestAdapter(getContext(), modals, listener);
