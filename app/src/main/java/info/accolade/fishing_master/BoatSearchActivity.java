...
public class BoatSearchActivity extends AppCompatActivity {
    ApiInterface apiIterface;
    ProgressDialog progressDialog;

    ArrayList<SearchModal> modals = new ArrayList<>();
    private SearchBoatAdapater adapter;
    RecyclerView recycle;
    SearchBoatAdapater.RecyclerViewClickListener listener;
    LinearLayout layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boat_search);

        editText = findViewById(R.id.etboatSearch);
        ...
        recycle = findViewById(R.id.boatRecycle);
        layout = findViewById(R.id.boatlayoyt);
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            ...
                            listener = new SearchBoatAdapater.RecyclerViewClickListener() {
                                @Override
                                public void onClick(View v, int position) {
                                    Intent i = new Intent(BoatSearchActivity.this, DetailsActivity.class);
                            ...
                            adapter = new SearchBoatAdapater(getApplicationContext(), modals, listener);
    ...
    private void filter(String text) {
        ...
        for (SearchModal item : modals) {
            if (item.getBoatname().toLowerCase().contains(text.toLowerCase())) {
